...
export const metadata = {
  title: "UK Aerials Case Study | Access Web Limited",
  description: "Learn how we built a React-based website for UK Aerials, a leading aerial installation company.",
}

export default function UKAerialsCaseStudy() {
  return (
      ...
      <div className="flex flex-col gap-8">
        <div>
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">UK Aerials</h1>
            <p className="text-xl text-muted-foreground">Aerial installation company website</p>
          </div>
        ...
        <div className="grid gap-10 md:gap-16 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-lg border p-4">
                  <h3 className="font-bold mb-2">Service Booking</h3>
                ...
                <div className="rounded-lg border p-4">
                  <h3 className="font-bold mb-2">Coverage Checker</h3>
                  <p className="text-sm text-muted-foreground">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore
                    et dolore magna aliqua.
                  </p>
            ...
            <section className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                <div className="rounded-lg bg-muted p-4 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">More Online Bookings</p>
                </div>
                <div className="rounded-lg bg-muted p-4 text-center">
            ...
            <section className="space-y-4">
              ...
              <p className="font-medium">- David Wilson, Managing Director at UK Aerials</p>
            </section>
          </div>
          ...
          <div className="space-y-6">
            <div className="rounded-lg border p-6 space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">UK Aerials</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <a href="https://ukaerials.co.uk" className="font-medium text-primary hover:underline">
                    ukaerials.co.uk
                  </a>
                </div>
              </div>
            ...
            <div className="rounded-lg border p-6 space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 shrink-0" />
                  <span>Coverage area checker</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 shrink-0" />
                  <span>Service package comparison</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-5 w-5 text-primary mt-0.5 shrink-0" />
